...
const FooterIndex = () => {
    ...
    return (
        <>
            ...
            <div className="bg-DarkGreen text-center px-[75px] max-[736px]:px-4 max-2xl:px-[55px] border-t-2 border-t-white">
                <div className="font-semibold text-sm tracking-[0.02em] py-[15px]
                max-[996px]:text-xs flex justify-center items-center max-[540px]:flex-col max-[540px]:gap-3
                ">
                    ...
                    <p className="text-[15px] max-lg:text-[13px] text-white max-[872px]:!text-[11px]">Copyright © 2025. All Rights Reserved. Developed with care for our community</p>
                </div>
            </div>
        </>
    )
