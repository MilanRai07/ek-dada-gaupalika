...
const Subscribe = () => {
    ...
    return (
        <div className='w-[330px] max-[996px]:w-[250px] max-xl:w-[180px] max-[996px]:text-center max-[764px]:w-[400px] max-[433px]:w-full
        ...
        '>
            ...
            <div className="mt-3 flex items-center  rounded-[10px] bg-white px-3 py-2 cursor-pointer w-[300px] h-[54px] 
            max-[996px]:h-[45px] max-xl:h-[37px] max-[528px]:w-[200px]
            ...
            ">
                ...
                />
                {
                    isSubmitting ? (
                        ...
                        >
                            <Mail className="h-[23px] w-[23px]  fill-black hover:fill-MainRed transition-all duration-300" />
                        </button>
                    )
                }
